  ...
  return (
      <div className="home__container container grid">
        ...
        -0.149132 97.9666 0.00163737C136.23 0.303176 174.193 10.857 190.312 36.4879Z"/>
                          <image className="home__blob-img" x={12} y={18} href=
                              "https://raw.githubusercontent.com/bedimcode/responsive-portfolio-website-Alexa/main/assets/img/perfil.png"/>
                      </g>
                  </svg>
              </div>

              <div className="home__data">
                  <h1 className="home__title">Hi, I'm Felix!</h1>
